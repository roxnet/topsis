                ...
                <div class="panel-body">
                    <form class="form-horizontal">
                        <div class="form-group">
                            <label class="control-label col-sm-3" for="no_pegawai">NO PEGAWAI :</label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group" id="nama_group">
                            <label class="control-label col-sm-3" for="nama_pegawai">NAMA PEGAWAI :</label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group" id="jekel_group">
                            <label class="control-label col-sm-3" for="jekel">JENIS KELAMIN :</label>
                        ...
                        <div class="form-group" id="status_group">
                            <label class="control-label col-sm-3" for="status">STATUS PERKAWINAN :</label>
                            <div class="col-sm-4">
                        ...
                        <div class="form-group" id="no_telp_group">
                            <label class="control-label col-sm-3" for="no_telp">NO TELPONE :</label>
                            <div class="col-sm-4">
                        ...
                        <div class="form-group" id="tgl_msk_group">
                            <label class="control-label col-sm-3" for="tanggal_masuk">TANGGAL MASUK :</label>
                            <div class="col-sm-3">
                                <div class='input-group date datetimepicker1'>
 ...
 $(document).ready(function () {
          $("#tambah").click(function () {
            ...
            $.ajax({
              ...
              data: 'crud=tambah&no_pegawai=' + no_pegawai + '&nama_pegawai=' + nama_pegawai,
