...
<?php /*php pembuka tabel atas*/
  ...
  while ($data=mysqli_fetch_array($hasil)) {
	...
	echo "<td align='center'>{$data['no_pegawai']}</td>"
		...
		."<td align='center'><a href='biodata_koordinator.php?no_pegawai={$data['no_pegawai']}'>&nbsp; Detail &nbsp; |</a>
		<a href='koordinator_hapus.php?no_pegawai={$data['no_pegawai']}' 
		onclick='return confirm(\"Yakin menghapus Bagian {$data['nama']}????\");'>Hapus &nbsp;</a></td>";
