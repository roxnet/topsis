...
<?php /*php pembuka tabel atas*/
  ...
  $sql = "select * from pegawai p, bagian b, riwayat_pegawai k
			where k.no_pegawai=p.no_pegawai
			and k.id_bagian=b.id_bagian
			and k.no_pegawai='$no_pegawai'";
  	$hasil = mysqli_query($db_link,$sql);
	$tampil=mysqli_fetch_array($hasil);
	echo'<center>';
	echo '<table border="0" >
  <tr>
    <td colspan="3" align="center">BIODATA KOORDINATOR</td>
  </tr> <tr>
  ...
  <tr>
    ...
    <td>:</td>
	<td>'.date("d-m-Y",strtotime($tampil['tmt'])).'</td>
  </tr>
  <tr>
    <td colspan="3">&nbsp;</td>
  </tr>
