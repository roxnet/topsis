...
<form name="submit" action="bagian_proses.php" method="post" onsubmit="return cek()" >
<center>
...
<table align="center" border="0" cellpadding="3" cellspacing="3">
 <tr>
  <td> ID Bagian </td>
  <td> : </td>
  <td> <input type="text" name="id_bagian" disabled autocomplete="off" size="8" value="<?php echo $newID;?>"/>
  ...
  <td> Nama Bagian </td>
   <td> : </td>
  <td><input type="text" name="bagian" size="30" maxlength="20"  onkeypress="return huruf(event)"></td>
 </tr>
